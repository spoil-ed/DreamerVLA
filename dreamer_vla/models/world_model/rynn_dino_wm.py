...
from dreamer_vla.models.world_model.base_world_model import BaseWorldModel
...
class RynnDinoWMWorldModel(BaseWorldModel):
    ...
    def freeze_backbone(self) -> int:
        ...
        The precomputed-hidden Rynn-DINO route does not instantiate the upstream
        RynnVLA/DINO encoder, so this is intentionally a no-op there.  We keep
