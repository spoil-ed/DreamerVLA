#!/usr/bin/env bash
# v4-C-deep BEST ckpt (epoch=004, loss=147.99) diff diagnostic.
set +e
...
RUN=action_diff_v4Cdeep_e004_chunk_wm_gpu5_${TS}
OUT=/home/user01/liops/workspace/DreamerVLA/data/outputs/dreamervla_diag/${RUN}
WM_CKPT=/home/user01/liops/workspace/DreamerVLA/data/outputs/dreamervla_diag/wm_pretrain_legacy_v4Cdeep_u12288L3_gpu7_20260521_073632/checkpoints/epoch=004-epoch_wm_loss=147.9857.ckpt
