#!/usr/bin/env bash
# v4-C-deep mid-training diff diagnostic (epoch=003, loss=148.0).
# Tests WM-wrapped success on libero_goal task 0 using chunk_replay mode.
set +e
...
RUN=action_diff_v4Cdeep_e003_chunk_wm_gpu4_${TS}
OUT=/home/user01/liops/workspace/DreamerVLA/data/outputs/dreamervla_diag/${RUN}
WM_CKPT=/home/user01/liops/workspace/DreamerVLA/data/outputs/dreamervla_diag/wm_pretrain_legacy_v4Cdeep_u12288L3_gpu7_20260521_073632/checkpoints/epoch=003-epoch_wm_loss=148.0123.ckpt
CFG=/home/user01/liops/workspace/DreamerVLA/configs/dreamer_vla_libero_goal_pi0_legacy_action_hidden_head_actor_v4c_deep.yaml
...
python -m scripts.eval_action_diff_wm_vs_sft \
  ...
  --task-suite libero_goal --task-ids 0 --num-episodes 5 --episode-horizon 200 \
