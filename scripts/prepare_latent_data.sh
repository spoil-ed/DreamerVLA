...
#
# The source pixel dataset is never overwritten.  By default this writes:
#   data/processed_data/libero_goal_no_noops_t_256_rynn_hidden
#
# Usage:
...
DEFAULT_OUT_DIR="${PROJECT_ROOT}/data/processed_data/${LIBERO_TASK_SUITE}_no_noops_t_${IMAGE_RESOLUTION}_rynn_hidden"
