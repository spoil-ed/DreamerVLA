...
| `preprocess/32_input_token_hidden.sh` | Extract RynnVLA frame-level input-token sidecars |
| `preprocess/35_oft_action_hidden.sh` | Extract OpenVLA-OFT action-hidden or input-token sidecars (L1 or discrete checkpoints) |
