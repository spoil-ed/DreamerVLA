...
| `experiments/wm_full_dataset_train.sh` | Launch `experiment=wm_full_dataset_train`; the Hydra recipe owns full-replay WM hyperparameters while the shell owns only local H100/DDP runtime setup |
