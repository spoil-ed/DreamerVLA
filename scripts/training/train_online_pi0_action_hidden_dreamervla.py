...
def main() -> None:
    ...
    # DDP-wrap the three trainable modules. Encoder, ref_policy, target_critic,
    # and classifier (loaded below) stay un-wrapped — they're frozen and don't
    # need gradient sync. find_unused_parameters=True because outcome.py's
