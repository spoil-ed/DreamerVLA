...
DEFAULT_HIDDEN_DIR = "data/processed_data/libero_goal_no_noops_t_256_pi0_legacy_action_hidden_vla_policy_h2"
...
def main() -> None:
    ...
    parser.add_argument("--out_dir", default="data/wmpo/classifier_shards/libero_goal")
