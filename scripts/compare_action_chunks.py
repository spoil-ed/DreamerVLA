...
(``configs/dreamer_vla_libero_goal_native_vla_actor.yaml``):
...
sys.path.insert(0, "/home/user01/liops/workspace/DreamerVLA")
...
def main() -> None:
    ...
    parser.add_argument("--config", default="configs/dreamer_vla_libero_goal_native_vla_actor.yaml")
    parser.add_argument(
        "--encoder-ckpt",
        default="/home/user01/liops/workspace/DreamerVLA/data/ckpts/pi0_query_vla_libero_goal/epoch003_train_vla_loss1.255_success8of10.ckpt",
