...
RUN=wm_pretrain_legacy_v4D_pi0xform_L4d1024m8_gpu5_resurrect_${TS}
...
echo "===== ${RUN} start ====="; date
python -m torch.distributed.run --standalone --nnodes=1 --nproc-per-node=1 --master-port=29521 -m dreamer_vla.cli.train \
