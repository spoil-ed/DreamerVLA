...
PI0_QUERY_WM_OUT_DIR="${PI0_QUERY_WM_OUT_DIR:-$(output_layout_path "${PROJECT_ROOT}" worldmodel rynn_backbone_dreamerv3_wm pi0_query_action_hidden "${PIPELINE_ID}")}"
PI0_QUERY_DREAMERVLA_OUT_DIR="${PI0_QUERY_DREAMERVLA_OUT_DIR:-$(output_layout_path "${PROJECT_ROOT}" dreamervla pi0_action_hidden_actor pi0_query "${PIPELINE_ID}")}"
