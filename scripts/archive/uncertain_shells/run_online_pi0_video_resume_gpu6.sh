...
ROOT=/mnt/data/spoil/workspace/DreamerVLA
PYTHON=/home/user01/miniconda3/envs/dreamervla/bin/python
source "${ROOT}/scripts/lib/output_layout.sh"
OUT_DIR="${OUT_DIR:-$(output_layout_path "${ROOT}" dreamervla online_dense_chunk pi0_h2_pi06wm11000 gpu6_20260514)}"
