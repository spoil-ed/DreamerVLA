...
WM_CKPT=/mnt/data/spoil/workspace/DreamerVLA/data/outputs/logs/dreamervla_diag/wm_pretrain_legacy_v4D_resnet_L4u8192_gpu4_20260521_150244/checkpoints/epoch=004-epoch_wm_loss=137.3548.ckpt
CFG=/mnt/data/spoil/workspace/DreamerVLA/configs/dreamer_vla_libero_goal_pi0_legacy_action_hidden_head_actor_v4d_resnet.yaml
