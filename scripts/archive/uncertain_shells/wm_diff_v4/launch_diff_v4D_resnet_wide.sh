...
WM_CKPT=/mnt/data/spoil/workspace/DreamerVLA/data/outputs/logs/dreamervla_diag/wm_pretrain_legacy_v4D_resnet_L4u16384_gpu6_20260521_153910/checkpoints/epoch=004-epoch_wm_loss=86.6151.ckpt
CFG=/mnt/data/spoil/workspace/DreamerVLA/configs/dreamer_vla_libero_goal_pi0_legacy_action_hidden_head_actor_v4d_resnet_wide.yaml
