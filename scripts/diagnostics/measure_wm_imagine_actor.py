...
def main():
    ...
    wm_state, wm_mismatched = prepare_state_dict(world_model, ckpt["state_dicts"]["world_model"])
    ...
    policy_state, policy_mismatched = prepare_state_dict(trained_policy, ckpt["state_dicts"]["policy"])
    policy_missing, policy_unexpected = trained_policy.load_state_dict(policy_state, strict=True)
    print(
