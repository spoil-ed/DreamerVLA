...
This directory is organized by document lifetime and reader intent.
...
- [`reviews/2026-08-18-pi05-lerobot-mainline.md`](reviews/2026-08-18-pi05-lerobot-mainline.md):
  π0.5 LeRobot dataloader/default-download mainline review record.
...
- [`../spec/`](../spec/): architecture map for overview, complete loop, and Ray
  implementation.
