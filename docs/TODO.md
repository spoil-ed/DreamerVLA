...
### 4. xllmx import 路径修复（2026-05-27 清理时发现，2026-05-28 已处理）

- [x] `dreamer_vla/preprocess/item_processor.py` 不再导入不存在的 `dreamer_vla.xllmx`。
- [x] 活跃的 xllmx 预处理 helper 已归入 `dreamer_vla/preprocess/xllmx/`；历史孤儿代码归入 `docs/archive/graveyard/`。
