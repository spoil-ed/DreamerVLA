...
- Step: `Step 2c`
- Status: `DONE`
- Reason: Step 2c verification passed for defaults, collect real EGL smoke, single-GPU fail-fast, helper wiring, and direct cotrain-real EGL reset+step. Full 5-step cotrain/SR validation remains Step 3.
