...
讲到 manual cotrain，并说明 trajectory 如何直接进入 ActorGroup 做 PPO。Ray 层的 worker graph、
placement 和 channel 实现见 [`02_ray.md`](02_ray.md)，当前代码事实见
[`03_current_implementation.md`](03_current_implementation.md)。
...
主线（细节见 [`06_sync_checkpoint_metrics.md`](06_sync_checkpoint_metrics.md)）。
...
同步分三类（细节见 [`06_sync_checkpoint_metrics.md`](06_sync_checkpoint_metrics.md)）：
