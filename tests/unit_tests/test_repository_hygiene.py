...
def test_runtime_fragments_are_consolidated() -> None:
    ...
    expected_definitions = {
        "dreamervla/runtime/metrics.py": "SuccessTracker",
        "dreamervla/runtime/rollout_collection_ray.py": "build_oft_collect_config",
    }
    for relative, expected_name in expected_definitions.items():
