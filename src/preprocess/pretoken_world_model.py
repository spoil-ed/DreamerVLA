...
if __name__ == "__main__":
    ...
    parser.add_argument('--tokenizer_path', type=str, default=str(DEFAULT_TOKENIZER_PATH), help="tokenizer path inside DreamerVLA/data/ckpts")
    ...
    for data_t in data_type:
        ...
        in_filename_path = in_filename_dir / f'libero_{args.task}_his_{args.his}_{data_t}_{img_item}_a2i_{args.resolution}.json'
        out_dir = out_root / f'libero_{args.task}_his_{args.his}_{data_t}_{img_item}_a2i_{args.resolution}'
