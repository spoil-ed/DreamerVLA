...
from src.models.chameleon_model import chameleon_vae_ori
from src.preprocess.convertsation import Conversation
from src.preprocess.paths import DEFAULT_CHAMELEON_TOKENIZER_DIR, DEFAULT_TOKENIZER_PATH
from src.xllmx.data.data_reader import read_general
from src.xllmx.data.item_processor import MMConvItemProcessor
...
class FlexARItemProcessor(MMConvItemProcessor):
    ...
    def __init__(
        ...
        self.chameleon_ori_vocab = chameleon_vae_ori.VocabInfo(
            json.load(open(DEFAULT_CHAMELEON_TOKENIZER_DIR / "text_tokenizer.json", encoding="utf8"))["model"]["vocab"]
        )
