...
class OpenVLAOFTTrainingWorkspace(BaseWorkspace):
    """OpenVLA-OFT VLA continuation training inside DreamerVLA."""

    workspace_name = "openvla_oft_impl"
    workspace_status = "implementation"
    ...
    def run(self) -> list[dict[str, float | int | str]]:
        ...
        if self.distributed.is_main_process:
            ...
            print("OpenVLA-OFT Workspace begin.", flush=True)
...
__all__ = ["OpenVLAOFTTrainingWorkspace"]
