# `src/models/world_model` — engineering structure
...
world_model:
  ...
  ...
  hidden_decoder:
    _target_: src.models.world_model.dreamerv3_torch.PerTokenMLPHead
    in_dim: 10240
    n_tokens: 35
    token_dim: 1024
    query_dim: 128
...
* **Use it** → cfg `_target_: src.models.world_model.<file>.<NewClass>`. No rewrites elsewhere.
