    ...
    while i < len(argv):
        ...
        if arg in ("-h", "--help"):
            print(
                ...
                "  python -m dreamervla.train experiment=world_model_dinowm_chunk training.num_epochs=20\n"
                "  python -m dreamervla.train experiment=dreamervla_rynn_dino_wm_actor_critic task=libero_object"
            )
            raise SystemExit(0)
