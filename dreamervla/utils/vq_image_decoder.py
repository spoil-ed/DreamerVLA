...
Reference:
    ImageTokenizer.pil_from_img_toks()
        dreamervla/models/embodiment/chameleon_model/chameleon_vae_ori/image_tokenizer.py:117
"""
...
from dreamervla.models.embodiment.chameleon_model.chameleon_vae_ori.vqgan import VQModel
