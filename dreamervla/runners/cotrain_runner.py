...
class CotrainRunner(BaseRunner):
    ...
    def _build_groups(self, cluster: Cluster) -> dict[str, Any]:
        ...
        real_env_group = None
        if not real_specs:
            raise ValueError("CotrainRunner placement requires a real_env worker")
        ...
        if wm_specs:
            ...
            raise ValueError("CotrainRunner requires at least one WMEnvWorker")
        ...
        if plan.learner_spec is None:
            raise ValueError("CotrainRunner requires a learner placement")
    ...
    def _maybe_save_manual_checkpoint(
        ...
        *,
        ...
        if learner_group is None:
            raise RuntimeError("CotrainRunner checkpoint requires LearnerGroup")
