...
class EmbodiedEvalExportMixin:
    ...
    def _write_policy_trace(
        ...
        *,
        ...
        input_token_grid: Any | None = None,
        live_input_token_grid: Any | None = None,
        recon_input_token_grid: Any | None = None,
        ...
        optional_arrays = {
            "input_token_grid": self._to_numpy_array(input_token_grid),
            "live_input_token_grid": self._to_numpy_array(live_input_token_grid),
            "recon_input_token_grid": self._to_numpy_array(recon_input_token_grid),
