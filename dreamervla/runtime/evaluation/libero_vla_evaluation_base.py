...
from dreamervla.utils.checkpoint.hf_checkpoint import resolve_hf_checkpoint_dir
...
class LIBEROVLAEvaluationBase(BaseRunner):
    runner_name = "vla_sft"
    ...
    def _evaluate_libero_rlinf_chunk(
        ...
        *,
        ...
        barrier = getattr(distributed, "object_barrier", None) if distributed_eval else None
...
__all__ = ["LIBEROVLAEvaluationBase"]
