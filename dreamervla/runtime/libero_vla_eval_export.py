"""Eval debug-export helpers for LIBEROVLAEvaluationRunner.
...
class EmbodiedEvalExportMixin:
    ...
    def _write_policy_trace(
        ...
        *,
        ...
        hidden_token_grid: Any | None = None,
        live_hidden_token_grid: Any | None = None,
        recon_hidden_token_grid: Any | None = None,
        ...
        optional_arrays = {
            "hidden_token_grid": self._to_numpy_array(hidden_token_grid),
            "live_hidden_token_grid": self._to_numpy_array(live_hidden_token_grid),
            "recon_hidden_token_grid": self._to_numpy_array(recon_hidden_token_grid),
