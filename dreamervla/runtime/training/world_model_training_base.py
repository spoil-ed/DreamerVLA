...
from dreamervla.utils.config.paths import checkpoints_path, data_path
...
from dreamervla.utils.training.optim import build_optimizer
...
class WorldModelTrainingBase(BaseRunner):
    ...
    def _maybe_build_viz(self) -> None:
        ...
        try:
            from dreamervla.utils.visualization.vq_image_decoder import load_vq_model
    ...
    def _decode_token_view(self, token_ids: torch.Tensor, h: int, w: int):
        from dreamervla.utils.visualization.vq_image_decoder import (
            tensor_to_pil,
            vq_tokens_to_pixels,
        )
    ...
    def _extract_image_bpe_ids(
        ...
        """
        from dreamervla.utils.visualization.wm_image_viz import extract_image_blocks
...
__all__ = ["WorldModelTrainingBase"]
