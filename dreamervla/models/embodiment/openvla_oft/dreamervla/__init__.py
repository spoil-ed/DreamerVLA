...
def get_model_config_and_input_processor(cfg: DictConfig):
    ...
    from dreamervla.models.embodiment.openvla_oft.processing_prismatic import (
...
def get_model(cfg: DictConfig, torch_dtype=torch.bfloat16):
    ...
    from dreamervla.models.embodiment.openvla_oft.dreamervla.openvla_oft_action_model import (
