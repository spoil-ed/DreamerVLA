...
Usage:
    python -m dreamervla.diagnostics.evaluation.eval_chunkwm_closeloop \
...
from dreamervla.runtime.training.world_model_training_common import _component_hydra_cfg
...
def main() -> None:
    ...
    pairs = find_demo_pairs(args.success_dir_raw, args.success_dir_hidden)[: args.num_demos]
