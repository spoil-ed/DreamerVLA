"""Exercise the official OpenPI π0.5 loader under torchrun without a model."""
...
from dreamervla.dataset.pi05_sft import build_official_openpi_sft_dataloader
...
def run(args: argparse.Namespace) -> list[dict[str, Any]]:
    ...
    loader, _data_config = build_official_openpi_sft_dataloader(
        model_path=str(args.model_path),
        assets_path=str(args.assets_path),
        data_paths=str(args.data_path),
