...
Lives alongside the other ``diagnostics/fixtures`` components so Ray actors can
import it when a learner worker is launched with one of these as its replay.
"""
