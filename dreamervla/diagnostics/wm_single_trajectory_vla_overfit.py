    ...
    *,
    ...
    with h5py.File(raw_hdf5, "r") as hdf5:
        ...
        for start in range(0, raw_episode.states.shape[0], batch_size):
            ...
            _, _, _, input_tokens, lang_emb = _predict_intermediates_chunk(
                ...
                want_action=False,
                want_input_tokens=True,
            )
            if input_tokens is None or lang_emb is None:
                raise RuntimeError("VLA did not return input-token embeddings")
